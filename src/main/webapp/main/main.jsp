	...
	<body>
		...
		<div class="book">
			...
			<div id="left" class="book_left">
				<jsp:include page="/category/primaryClassification.do" />
			</div>
			<!--左栏结束-->
			...
			<div class="book_center">
				...
				<div class=second_c_border1 id="recommend">
					<jsp:include page="/product/recommend.do" />
				</div>
				<!--推荐图书结束-->
	
				<!--热销图书开始-->
				<div class="book_c_border2" id="hot">
					<jsp:include page="/product/hotBook.do" />
				</div>
				<!--热销图书结束-->
	
				<!--最新上架图书开始-->
				<div class="book_c_border2" id="new">
					<jsp:include page="/product/newBook.do" />
				</div>
				<!--最新上架图书结束-->
				...
				<div class="book_r_border2" id="__XinShuReMai">
					<div class="book_r_b2_1x" id="new_bang">
						<div id="NewProduct_1_o_t" onmouseover="">
							<jsp:include page="/product/newHotBook.do" />
						</div>
					</div>
				</div>
			</div>
