	...
	<body>
		...
		<div class="enter_part">
			...
			<div class="enter_in">
				...
				<div class="center">
					<div style="height: 30px; padding: 5px; color: red"id="divErrorMssage">${requestScope.error }</div>
					<div class="main">
						<h3>登录当当网</h3>

						<form method="post" action="${pageContext.request.contextPath }/user/login.do" id="ctl00">
							<ul>
								<li>
